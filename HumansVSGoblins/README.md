eThis is an extremely simple grid-based rpg with turn-based mechanics. In its current state it's playable, but must be relaunched every time you run out of health.
